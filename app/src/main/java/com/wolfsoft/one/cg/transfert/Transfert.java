package com.wolfsoft.one.cg.transfert;
...
public class Transfert extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        networkConnection = new NetworkConnection(Transfert.this);
        ...
        alb = new AlertDialog.Builder(Transfert.this);
            ...
            public void onClick(View v) {
                ...
                if(etreciamount.getText().toString().isEmpty() || etrecifname.getText().toString().isEmpty() || etrecilname.getText().toString().isEmpty() || etreciphone.getText().toString().isEmpty() || etsendpin.getText().toString().isEmpty()){
                    ...
                    if(networkConnection.isConnected()){
                        try {
                            PostResponseAsyncTask tache = new PostResponseAsyncTask(Transfert.this, dt, false, new AsyncResponse() {
                                @Override
